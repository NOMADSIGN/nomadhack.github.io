...
function loadMusic(indexNumb){
   mainVideo.src = `https://archive.org/download/obys1/${allVideos[indexNumb - 1].src}.mp4`;
...
for(let i = 0; i < allVideos.length; i++){
   let liTag = `<li li-index="${i + 1}">
      ...
      <video class="${allVideos[i].id}" src="https://archive.org/download/obys1/${allVideos[i].src}.mp4" style="display: none;" title="${allVideos[i].name}"></video>
